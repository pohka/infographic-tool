...
$(document).on('click', '#template-02', function(){
	var html =
		...
		'<div class="row">' +
			'<div class="col-xs-3 template-02-chart" id="template-02-chart-1">' +
			...
			'<div class="col-xs-3 template-02-chart" id="template-02-chart-2">' +
			...
			'<div class="col-xs-3 template-02-chart" id="template-02-chart-3">' +
