...
$(document).ready(function(){
	...
	if($(".team-07").length)
  {
    $(".team-07-win-rate").each(function(){
      var val = $(this).text();;
      var canvasID="";
      var wrIndex=0;
      ...
      $.each(classList, function(index, item) {
          if (item.indexOf('team-07-win-rate-')>=0) {
              wrIndex = item.replace("team-07-win-rate-", "");
              canvasID = "team-07-canvas-" + wrIndex;
          }
      });

      val = Number(val).clamp(100,0);
      var size;
      if(wrIndex==1)
        size=50;
      else if(wrIndex==2)
        ...
        console.log("cnavas:" + canvasID+","+"val:"+val+",size:"+size);

      arc(val, canvasID, true, size);
    });
  }
});
  ...
  '<div class="container">' +
    ...
    '<div class="row">' +
      ...
      '<div class="col-xs-5 team-07-top-row">' +
        ...
        '</div>' +
        '<canvas class="canvas canvas-circle team-07-canvas" id="team-07-canvas-1"></canvas>' +
      ...
      '<div class="col-xs-5">' +
        ...
        '</div>' +
        '<canvas class="canvas canvas-circle team-07-canvas" id="team-07-canvas-2"></canvas>' +
    ...
    '<div class="row">' +
      '<div class="col-xs-4">' +
        ...
        '</div>' +
        '<canvas class="canvas canvas-circle team-07-canvas" id="team-07-canvas-3"></canvas>' +
      ...
      '<div class="col-xs-4">' +
        ...
        '</div>' +
        '<canvas class="canvas canvas-circle team-07-canvas" id="team-07-canvas-4"></canvas>' +
      ...
      '<div class="col-xs-4">' +
        ...
        '</div>' +
        '<canvas class="canvas canvas-circle team-07-canvas" id="team-07-canvas-5"></canvas>' +
